...
<div class="d-flex justify-content-between align-items-center pt-3 pb-2 mb-4 border-bottom">
    ...
    <a href="index.php?page=productadd&category=<?= $_GET['category'] ?>" class="btn btn-success">
        เพิ่มสินค้า
    </a>
</div>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            <a href="index.php?page=product&delete=<?= $row['id'] ?>"
                                onclick="return confirm('ยืนยันการลบสินค้า?')" class="btn btn-sm btn-outline-danger">ลบ</a>
                        </td>
                    </tr>
                <?php endwhile; ?>
            </tbody>
